...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Clipboard-0.30.tar.gz
...
%prep
%setup -q -n Clipboard-0.30
cd %{_builddir}/Clipboard-0.30
pushd ..
cp -a Clipboard-0.30 buildavx2
popd
