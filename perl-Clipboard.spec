...
Version  : 0.27
Release  : 22
URL      : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Clipboard-0.27.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Clipboard-0.27.tar.gz
...
%prep
%setup -q -n Clipboard-0.27
cd %{_builddir}/Clipboard-0.27
...
cp %{_builddir}/Clipboard-0.27/LICENSE %{buildroot}/usr/share/package-licenses/perl-Clipboard/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Clipboard.pm
/usr/lib/perl5/vendor_perl/5.30.3/Clipboard/MacPasteboard.pm
/usr/lib/perl5/vendor_perl/5.30.3/Clipboard/Win32.pm
/usr/lib/perl5/vendor_perl/5.30.3/Clipboard/Xclip.pm
