...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Clipboard-0.25.tar.gz
...
%prep
%setup -q -n Clipboard-0.25
cd %{_builddir}/Clipboard-0.25
...
cp %{_builddir}/Clipboard-0.25/LICENSE %{buildroot}/usr/share/package-licenses/perl-Clipboard/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/Clipboard.pm
/usr/lib/perl5/vendor_perl/5.30.2/Clipboard/MacPasteboard.pm
/usr/lib/perl5/vendor_perl/5.30.2/Clipboard/Win32.pm
/usr/lib/perl5/vendor_perl/5.30.2/Clipboard/Xclip.pm
