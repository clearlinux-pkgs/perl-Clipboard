...
Source0  : https://cpan.metacpan.org/authors/id/S/SH/SHLOMIF/Clipboard-0.26.tar.gz
...
%prep
%setup -q -n Clipboard-0.26
cd %{_builddir}/Clipboard-0.26
...
cp %{_builddir}/Clipboard-0.26/LICENSE %{buildroot}/usr/share/package-licenses/perl-Clipboard/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
