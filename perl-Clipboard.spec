...
%prep
%setup -q -n Clipboard-0.21
cd %{_builddir}/Clipboard-0.21
...
cp %{_builddir}/Clipboard-0.21/LICENSE %{buildroot}/usr/share/package-licenses/perl-Clipboard/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
